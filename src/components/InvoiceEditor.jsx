...
export default function InvoiceEditor({ invoice, onSave, onClose }) {
  ...
  return (
    <dialog
      ...
      className="m-auto max-h-[90dvh] w-[calc(100%-2rem)] max-w-md overflow-y-auto rounded-lg border border-white/15 bg-neutral-900 p-4 text-white shadow-xl backdrop:bg-black/70"
    >
